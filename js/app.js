(() => {
    ...
    (() => {
        ...
        const picker = datepicker_min("[data-datepicker_1]", {
        ...
        const picker2 = datepicker_min("[data-datepicker_2]", {
            customDays: [ "Пн", "Вт", "Ср", "Чт", "Пт", "Сб", "Вс" ],
            customMonths: [ "Янв", "Фев", "Мар", "Апр", "Май", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек" ],
            overlayButton: "Применить",
            overlayPlaceholder: "Год (4 цифры)",
        ...
        flsModules.datepicker = picker, picker2;
        ...
        function initSliders() {
            if (document.querySelector(".slider-gallery__body")) new core(".slider-gallery__body", {
...
***************************************************************************** */
        ...
        if (header && window.innerWidth < 479.98) {
            let menuBodySize = window.innerHeight - header + 1;
            menuBody.style.height = `${menuBodySize}px`;
        }
        document.addEventListener("click", (function(e) {
            if (e.target.classList.contains("icon-menu")) menuOpen();
            if (e.target.classList.contains("menu__icon-close")) menuClose();
        }));
        const headerButton = document.querySelector(".header__button");
        if (headerButton) headerButton.addEventListener("click", (function(e) {
            const pop = document.querySelector(".form-popup");
            if (pop.querySelectorAll(".form-error")) {
                const blockEr = pop.querySelectorAll(".form__error");
                const classEr = pop.querySelectorAll("._form-error");
                for (let index = 0; index < blockEr.length; index++) {
                    const el = blockEr[index];
                    for (let j = 0; j < classEr.length; j++) {
                        const item = classEr[j];
                        el.remove();
